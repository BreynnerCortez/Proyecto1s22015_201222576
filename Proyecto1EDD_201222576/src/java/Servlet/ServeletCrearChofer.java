 ...
 * @author Breynner
 */
@WebServlet(name = "ServeletCrearChofer", urlPatterns = {"/ServeletCrearChofer"})
public class ServeletCrearChofer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         String datosadm=request.getParameter("clave")+","+request.getParameter("contrase")+","+request.getParameter("nombre")+","+request.getParameter("apellido");
        String d= imprimirchofer();
        String a=buscarchofer(datosadm);
        if(buscarchofer(datosadm)!=null){
            String id=buscarchofer(datosadm).split(",")[0];
              if(id.compareTo(request.getParameter("clave"))==0){
...
"         </style>");
            ...
            out.println(" <a href=\"CrearChoferJSP.jsp\">Regresar</a>");
            out.println("</body>");
            out.println("</html>");
        }
              }
            ...
            ingresarchofer(datosadm);
             request.getRequestDispatcher("CrearChoferJSP.jsp").forward(request, response);
        }
    }
