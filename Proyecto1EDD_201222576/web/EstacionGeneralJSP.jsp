<%-- 
    Document   : EstacionGeneralJSP
    Created on : 19/09/2015, 10:26:39 PM
    Author     : Breynner
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Bienvenido Estacion: <jsp:getProperty name="datos" property="nombreEsGeneral" />! </h1>
        <form  method="POST" action="ServeletVerEsGeneral">
            <input type="submit" value="Ver Estaciones" name="VerAdmins" />
        </form><br>
